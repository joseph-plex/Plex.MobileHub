...
namespace Plex.MobileHub.Data.Tables
{
    public class DEV_DATA_VER_QUERIES : PlexxisDataTransferObjects
    {
        ...
        public int DATABASE_VERSION_ID;//DATABASE_VERSION_ID	NUMBER(10)	N
        public int QUERY_ID;//QUERY_ID	NUMBER(10)	N		
        public DateTime QUERY_EXECUTION_TIME;//QUERY_EXECUTION_TIME	DATE	N
